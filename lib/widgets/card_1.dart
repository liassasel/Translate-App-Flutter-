...
class TranslateCard1 extends StatefulWidget {
  const TranslateCard1({super.key});

  @override
  State<TranslateCard1> createState() => _TranslateCard1State();
}

class _TranslateCard1State extends State<TranslateCard1> {
  @override
